...
class mainModel
{
    ...
    {
        $sql = self::conectar()->prepare("INSERT INTO cuentas(cdcuenta,usuario,clave,privilegio,nombre,apellido_paterno,apellido_materno,puesto) "
            . "VALUES(:codigo,:nom_usuario,:contrasenia,:radio,:nombre,:appaterno,:apmaterno,:area)");
                        ...
                        <script>
                         swal({
                                  ...
                                  confirmButtonText: 'Aceptar'
                                    ...
                                    location.replace('/contenido/edicionsecciones/');
                                    });
                        </script>";
                        ...
                        <script>
                         swal({
                                  ...
                                  confirmButtonText: 'Aceptar'
                                    ...
                                    location.replace('/contenido/adminlist/');
                                    });
                        </script>";
