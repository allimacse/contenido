...
<!--                    <li>
                        <a href="<?php echo SERVERURL; ?>tiposecciones/" class="btn btn-success"><span class="glyphicon glyphicon-list-alt"></span>&nbsp;&nbsp;&nbsp;  Crear Menus</a>
                    </li>
                    <li>
                        <a href="<?php echo SERVERURL; ?>secciones/" class="btn btn-info"><span class="glyphicon glyphicon-list"></span>&nbsp;&nbsp;&nbsp;  Añadir Título</a>
                    </li>
                    <li>
                        <a href="<?php echo SERVERURL; ?>edicionsecciones/" class="btn btn-warning"><span class="glyphicon glyphicon-list-alt"></span>&nbsp;&nbsp;&nbsp;  Editar Secciones</a>
                    </li>-->
                    <li>
