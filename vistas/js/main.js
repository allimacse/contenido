...
//                }).then(function () {
                    $.ajax({
                            ...
                            url:'/contenido/vistas/contenidos/edicionseccionesAjax.php?id='+id,
...
//                }).then(function () {
                    $.ajax({
                            ...
                            url:'/contenido/ajax/eliminarAjax.php?cuenta='+cuenta,
                            success:function (data){
                            if(data=="TRUE"){
                                swal({
                                        title:"Eliminado",
...
//                               window.location.reload();      
                               ...
                               swal(
                                       ...
                                       "No se puede borrar la cuenta, debido a que el usuario ha tenido movimientos",
                                       "info"
                                    );
                           }
                       }
...
//                var persona=$('#persona:checked').val();//correcto
                ...
                swal({
                    ...
                    $.ajax({
                            ...
                            url:'/correspondencia/ajax/envioAjax.php?token='+codigo+'&persona='+persona+'&volante='+volante+'&instruccion='+instruccion+'&accion_implementar='+accion_implementar,
                            success:function (data){
                            if(data=="TRUE"){
//                               window.location.reload();
...
$(document).ready(function(){
    $('.desactivar').on('click', function(e){
        ...
        swal({
            title: '¿Estás Seguro?',
            text: "Estas apunto de desactivar el Título",
            type: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#03A9F4',
            cancelButtonColor: '#F44336',
            ...
            $.ajax({
                    url:'/contenido/ajax/desactivarAjax.php?titulo='+valor[0]+'&idtisecc='+valor[1],
                    success:function (data){
                    if(data=="TRUE"){
//                                console.log(codigo,volante,persona);
                        swal({
                                title:"Actualización",
                                text:"El título se desactivo",
                                type:"success",
                                confirmButtonText: 'Aceptar'
                                }).then(function(){
                                     window.location.reload();
...
$(document).ready(function(){
    $('.activar').on('click', function(e){
        ...
        swal({
            title: '¿Estás Seguro?',
            text: "Estas apunto de activar el Título",
            type: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#03A9F4',
            cancelButtonColor: '#F44336',
            ...
            $.ajax({
                    url:'/contenido/ajax/activarAjax.php?titulo='+valor[0]+'&idtisecc='+valor[1],
                    success:function (data){
                    if(data=="TRUE"){
//                                console.log(codigo,volante,persona);
                        swal({
                                title:"Actualización",
                                text:"El título se activo",
                                type:"success",
                                confirmButtonText: 'Aceptar'
                                }).then(function(){
                                     window.location.reload();
...
//                });
                ...
                swal({
                    ...
                    text: "Estas a un paso de recuperar tu contraseña",
                    type: 'info',
                    showCancelButton: true,
                    confirmButtonColor: '#03A9F4',
                    cancelButtonColor: '#F44336',
                    ...
                    $.ajax({
                            url:'/contenido/ajax/recuperarAjax.php?usuario='+usuario,
                            success:function (data){
...
//                           }
        ...
        //              var pdfnombre=document.getElementsByTagName("input")[0].value;
                        ...
                        swal({
                            ...
                            $.ajax({
                               url:'/correspondencia/ajax/concluidoAjax.php?token='+token+'&sigob='+sigob+'&pdfrespuesta='+respuesta,
