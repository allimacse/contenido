         ...
         public function agregar_administrador_controlador(){
            ...
            if($nombre === "")
            {
                $alerta = [
                   "Alerta"=>"simple2",
                   "Titulo"=>"Oh, no!",
                   "Texto"=>"El campo nombre esta vacío",
                   "Tipo"=>"info"
                ];
            }else
            {
                if($paterno === "")
                {
                    $alerta = [
                       "Alerta"=>"simple2",
                       "Titulo"=>"Oh, no!",
                       "Texto"=>"El campo paterno esta vacío",
                       "Tipo"=>"info"
                    ];
                }else
                {
                    if($materno === "")
                    {
                        $alerta = [
                           "Alerta"=>"simple2",
                           "Titulo"=>"Oh, no!",
                           "Texto"=>"El campo materno esta vacío",
                           "Tipo"=>"info"
                        ];
                    }else
                    {
                        if($area === "")
                        {
                            $alerta = [
                               "Alerta"=>"simple2",
                               "Titulo"=>"Oh, no!",
                               "Texto"=>"El campo puesto esta vacío",
                               "Tipo"=>"info"
                            ];
                        }else
                        {
                            if($nomusuario === "")
                            {
                                $alerta = [
                                   "Alerta"=>"simple2",
                                   "Titulo"=>"Oh, no!",
                                   "Texto"=>"El campo nombre de usuario esta vacío",
                                   "Tipo"=>"info"
                                ];
                            }else
                            {
                                    ...
                                    }else
                                    {
                                        if($tipo==="")
                                        {
                                            $alerta = [
                                               "Alerta"=>"simple2",
                                               "Titulo"=>"Oh, no!",
                                               "Texto"=>"Debes seleccionar un tipo de suario",
                                               "Tipo"=>"info"
                                            ];
                                        }else
                                        {
...
//                 $i=1;
                 foreach ($datos as $rows){
                    ...
                    if($estatus==1){
                        $tabla.='<td><a href="'.mainModel::encryption($nombre).' '.mainModel::encryption($rows['idtiposecciones']).'" class="desactivar btn btn-danger btn-raised btn-sm"> Desactivar <span class="glyphicon glyphicon-remove-sign"></span></a></td>';
                    }elseif($estatus==2){
                        $tabla.='<td><a href="'.mainModel::encryption($nombre).' '.mainModel::encryption($rows['idtiposecciones']).'" class="activar btn btn-success btn-raised btn-sm"> Activar <span class="glyphicon glyphicon-check"></span></a></td>';
                    }
                     $tabla.='  </tr>';
                     $contador++;
//                     $i++;
